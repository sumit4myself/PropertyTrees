...
echo.
echo -----------------------------------------------------------------------
echo WebientSoft EsyKart Eclipse/STS project import guide
echo.
echo This script will guide you through the process of importing the
echo EsyKart sources into Eclipse/STS. It is recommended that you
...
REM SET COMMAND="./gradlew cleanEclipse eclipse -x :eclipse"
SET COMMAND=gradlew cleanEclipse eclipse -x :eclipse
...
echo of the esykart-* subprojects. This happens via the built-in
