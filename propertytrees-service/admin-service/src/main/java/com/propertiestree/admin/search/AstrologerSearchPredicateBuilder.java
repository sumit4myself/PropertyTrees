...
@Component
public class AstrologerSearchPredicateBuilder extends SearchPredicateBuilder {
	...
	public Predicate build(List<SearchCriteria> criterias)
		...
		for (SearchCriteria criteria : criterias) {
			...
			case "city": {
				cityExpression = applyCityOperator(cityExpression, architect.city.name, criteria);
				break;
			}
			default: {
