...
import static com.propertiestree.common.entity.QAgent.*;

@Component
public class AgentSearchPredicateBuilder extends SearchPredicateBuilder {
	...
	public Predicate build(List<SearchCriteria> criterias)
		...
		for (SearchCriteria criteria : criterias) {
			switch (criteria.getField()) {
				case "city": {
					cityExpression = applyCityOperator(cityExpression, agent.city.name,
							criteria);
					break;
				}
				default: {
