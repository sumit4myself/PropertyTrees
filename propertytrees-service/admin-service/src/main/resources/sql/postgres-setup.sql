...
--school admin role
INSERT INTO role(name,description, status,level,created_by ,updated_by,default_page,type) VALUES ('School Admin Role','School Admin Role', 'A',2,1,1,(select id  as menu_id from menu where link = 'restricted.dashboards'),0);
...
--branch admin role
INSERT INTO role(name,description, status,level,created_by ,updated_by,default_page,type) VALUES ('Branch Admin Role','Branch Admin Role', 'A',3,1,1,(select id  as menu_id from menu where link = 'restricted.dashboards'),0);
...
INSERT INTO role(name,description, status,level,created_by ,updated_by,default_page,type) VALUES ('Student Role','Student Role', 'A',10,1,1,(select id  as menu_id from menu where link = 'restricted.dashboards'),0);
...
INSERT INTO users(email, mobile, full_name, user_name , password, status,system_user,module, remote_id, remote_name, service , created_by ,updated_by) VALUES ('sumit4myself@gmail.com', '9891939498', 'Super Admin', 'superAdmin','$uper@dmin', 'A',false,'USER',-1,'Super Admin', 'ADMINSERVICE',1,1);
...
INSERT INTO users(email, mobile, full_name, user_name , password, status,system_user,module, remote_id, remote_name, service, created_by ,updated_by) VALUES ('admin@educoresystems.in', '9891939498', 'Admin', 'admin','@dmin', 'A',false,'USER',-1,'Admin', 'ADMINSERVICE',1,1);
