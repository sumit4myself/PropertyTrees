...
getMaintenanceTypeOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.MAINTENANCE_TYPE);
    }
    
getFlooringTypeOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.FLOORING_TYPE_OPTION);
    }

getFacigMeasureOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.FACIG_MEASURE_OPTION);
    }

getFacigOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.FACIG_OPTION);
    }

getPowerBackupOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.POWER_BACKUP_OPTION);
    }
getPropertyAgeOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.PROPERTY_AGE_OPTION);
    }

getPossessionOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.POSSESSION_OPTION);
    }
getOwnerShipOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.OWNERSHIP_OPTION);
    }
getConfigOption() : Array<IOption> {
        return this.cloneOptions(ProjectService.CONFIG_OPTION);
    }
