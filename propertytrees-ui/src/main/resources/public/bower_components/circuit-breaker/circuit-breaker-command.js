...
(function(window) {
	...
	jQuery.get(getRelativePath("bower_components/circuit-breaker/circuit.html"), function(data) {
		hystrixTemplateCircuit = data;
	});
	jQuery.get(getRelativePath("bower_components/circuit-breaker/circuit-container.html"), function(data) {
