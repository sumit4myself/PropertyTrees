...
(function(window) {
	...
	jQuery.get(getRelativePath("bower_components/circuit-breaker/threadpool.html"), function(data) {
		htmlTemplate = data;
	});
	jQuery.get(getRelativePath("bower_components/circuit-breaker/threadpool-container.html"), function(data) {
