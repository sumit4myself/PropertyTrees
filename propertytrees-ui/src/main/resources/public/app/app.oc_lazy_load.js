        ...
        function($ocLazyLoadProvider) {
            $ocLazyLoadProvider.config({
                ...
                modules: [
                    ...
                    {
	                    name: 'lazy_circuit_breaker',
	                    files: [
	                        "bower_components/circuit-breaker/jquery.tinysort.min.js",
	                        "bower_components/circuit-breaker/tmpl.js",
	                        "bower_components/circuit-breaker/circuit-breaker-command.js",
	                        "bower_components/circuit-breaker/circuit-breaker-threadpool.js",
	                        "bower_components/circuit-breaker/circuit-breaker.css"
	                    ],
	                    serie: true
                    },

	                {
		                name: 'lazy_infiniteScroll',
		                files: [
		                     "bower_components/infinite-scroll/taggedInfiniteScroll.min.js"
		                 ],
		                 serie: true
		             },
                    ...
                    {
                        name: 'lazy_jquery_easyui',
                        files: [
                            'bower_components/jquery-easyui-1.5.1/jquery.easyui.min.js',
                            ],
                        serie: true
                    },
                    ...
                    {
                      name: 'lazy_ng_dropzone',
                      files: [
                          'bower_components/ng-dropzone/dist/dropzone.css',
                          'bower_components/ng-dropzone/dist/dropzone.js',
                          'bower_components/ng-dropzone/dist/ng-dropzone.js',
                          'bower_components/ng-dropzone/dist/ng-dropzone.css',
                      ],
                      serie: true
                    },
                    ...
                    {
                      name: 'lazy_json_schema_form',
                      files: [
                          "bower_components/json-schema-form/dist/jsoneditor.min.js",
                          "bower_components/json-schema-form/src/iconlibs/uikit.js",
                          "bower_components/json-schema-form/src/themes/uikit.js"
                      ],
                      serie: true
                    },
                    {
                        name: 'lazy_star_rating',
                        files: [
                            'bower_components/angular-jk-rating-stars-master/dist/jk-rating-stars.css',
                            'bower_components/angular-jk-rating-stars-master/dist/jk-rating-stars.js'
                        ],
                        serie: true
                    }
